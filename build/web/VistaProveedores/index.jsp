                    ...
                    <div class="col-lg-12">
                        <div class="card mb-0">
                            <div class="card-header">
                                <h2 class="h2 mb-0 text-center">PROVEEDORES</h2>
                            </div>
                            <div class="card-body pt-0">
                                <div class="table-responsive">
                                    <div class="nuevo">
                                        <a href="Controlador?accion=AgregarProveedores"> <i class="fa fa-plus-circle"></i> AGREGAR PROVEEDORES</a><br><br>
                                    ...
                                    <table class="table mb-0 table-striped table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <%
                                                ...
                                                List<Proveedores> list = prodao.listar();
                                            ...
                                            <tr>
                                                <td> <%=pro.getDocproveedor()%>   </td>
                                                <td> <%=pro.getNomempresa()%>   </td>
                                                <td> <%=pro.getNomproveedor() %>   </td>
                                                <td> <%=pro.getNumero()%>   </td>
                                                ...
                                                <td>
                                                    <a href="Controlador?accion=EditarProveedores&txtpro=<%=pro.getDocproveedor()%> "><i class="fa fa-pencil-square-o icon-lg"></i></a>
