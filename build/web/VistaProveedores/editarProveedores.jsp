                ...
                <div class="col-lg-12">
                  <div class="card mb-0">
                    <div class="card-header">
                      <h2 class="h2 mb-0 text-center">EDITAR PROVEEDORES</h2>
                    </div>
                    <div class="card-body pt-0">
                          ...
                          pro=prodao.list((String)request.getAttribute("codpro"));
                      ...
                      <form action="Controlador" class="form-horizontal">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                              <input class="form-control" type="text" value="<%=pro.getDocproveedor() %>"  name="txtdocproveedor" required >
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="text"  value="<%=pro.getNomempresa()%>"  name="txtnomempresa" required>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <label class="col-sm-3 form-label">PROVEEDOR</label>
                          <div class="col-sm-9">
                            <div class="input-group">
                              <input class="form form-control" type="text" value="<%=pro.getNomproveedor()%>" name="txtnomproveedor" required>
                            </div>                          
                          </div>
                        </div>     
                        <input type="hidden" name="accion" value="EditarProveedores"
                        <div class="my-4"></div>
                        
                        <div class="row">
                          <label class="col-sm-3 form-label">TELEFONO</label>
                          <div class="col-sm-9">
                            <input class="form-control" type="text" value="<%=pro.getNumero()%>" name="txtnumero" required>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="text" value="<%=pro.getRazonsocial()%>" name="txtrazonsocial" required>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="text" value="<%=pro.getDireccion()%>" name="txtdireccion" required>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="text" value="<%=pro.getCorreo()%>" name="txtcorreo" required>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="text" value="<%=pro.getEstado()%>" name="txtestado" required>
                          </div>
                        ...
                        <div class="container-fluid py-2">
                          <div class="modal-footer">
                            ...
                            <input class="btn btn-primary" type="submit" name="EditarProveedoresDB" value="EditarProveedoresDB">
                          </div>
                        </div>
                        <!--  -->
                        </form>
