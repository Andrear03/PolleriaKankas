...
<!DOCTYPE html> <%-- Inicio por Diego Andre Aranda Reyes--%>
<html>
  <head>  
    <meta charset="utf-8">
                ...
                <div class="col-lg-12">
                  <div class="card mb-0">
                    <div class="card-header">
                      <h2 class="h2 mb-0 text-center">Agregar Usuarios</h2>
                    </div>
                    ...
                    <div class="card-body pt-0">
                      <form action="Controlador" class="form-horizontal">
                        ...
                        <div class="row">
                          <label class="col-sm-3 form-label">IdUsuarios</label>
                          <div class="col-sm-9">
                              <input class="form-control" type="number" min="1"  name="txtidusuario" required>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="text"  name="txtnomusuario" required>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <div class="input-group">
                              <input class="form form-control" type="text" name="txtemail" required>
                            </div>                          
                          </div>
                        </div>     
                        <input type="hidden" name="accion" value="AgregarUsuarios">
                         <div class="my-4"></div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="text" name="txtclave" required>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-9">
                            <input class="form-control" type="number" min="1" name="txtfkidrol" required>
                          </div>
                        ...
                        <div class="container-fluid py-2">
                          <div class="modal-footer">
                            ...
                            <input class="btn btn-primary" name="AgregarUsuariosDB" value="AgregarUsuariosDB" type="submit"/>
                          </div>
                        </div>
                        <!--  -->
